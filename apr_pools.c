...
// static int add_number(int a,int b){
//     return a+b;
// }
...
{  
    ...
    */
    ...
    if (node == NULL || node->index == 64) {
        ...
        /*int apr=malloc(sizeof(struct node))*/
